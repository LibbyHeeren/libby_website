...
description: "Part 1 of a series documenting my learning process as I code a Shiny app that generates random artwork inspired by Ellsworth Kelly's Spectrum Colors by Chance Series"
date: "2024-03-13"
image: images/fearful-face.png
image-alt: "Fearful face emoji with raised eyebrows, blue forehead, and open mouth"
categories:
  - R
  - Shiny
...
::: {layout-ncol="2"}
![Original photograph from ellsworthkelly.org](images/Original-piece-III.png)
...
It was time to analyze the probabilities of the actual piece I was aiming for: piece III! But it was gonna have to wait until the next day. And so will the next blog post. I'll link the second post in the series here when it's ready. Hope you enjoyed my mayhem!  
