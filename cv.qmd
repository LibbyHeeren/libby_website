---
# THIS IS LEFTOVER FROM FORKING JADEY'S REPO
...
::: {.p-2}
![](assets/img/wsda.png){width="80px" fig-alt="Washington State Department of Agriculture logo"} 
:::
::: {.h3}
...
:::: {.d-inline-flex style="align-items:baseline"}
::: {.p-2}
![](assets/img/plu.gif){width="60px" fig-alt="Pacific Lutheran University logo"} 
:::
::: {.h3}
...
:::: {.d-inline-flex style="align-items:baseline"}
::: {.p-2}
![](assets/img/tacoma-water.jpeg){width="80px" fig-alt="Tacoma Water logo"}
:::
::: {.h3}
Tacoma Water
:::
...
:::: {.d-inline-flex style="align-items:baseline"}
::: {.p-2}
![](assets/img/omi.gif){width="60px" fig-alt="Ocean Mammal Institute logo"}
:::
::: {.h3}
...
:::: {.d-inline-flex style="align-items:baseline"}
::: {.p-2}
![](assets/img/msu.png){width="80px" fig-alt="Montana State University logo"}
:::
::: {.h3}
...
:::: {.d-inline-flex style="align-items:baseline"}
::: {.p-2}
![](assets/img/tcc.jpeg){width="60px" fig-alt="Tacoma Community College logo"}
:::
::: {.h3}
...
![](assets/img/dsh.png){width="60px" fig-alt="Data Science Hangout logo" style="padding-right:1em"} [Posit Data Science Hangout](https://posit.co/data-science-hangout/)

![](assets/img/r4ds.jpeg){width="60px" fig-alt="R4DS logo" style="padding-right:1em"} [R4DS Learning Community](https://rfordatasci.com/)

![](assets/img/wig.jpeg){width="60px" fig-alt="Women in GovTech logo" style="padding-right:1em"} [Women in GovTech](https://women-in-govtech.github.io/)

![](assets/img/rladiesseattle.gif){width="60px" fig-alt="R-Ladies Seattle logo" style="padding-right:1em"} [R-Ladies Seattle](https://rladiesseattle.org/)
...
[Web Scraping & Mapping {orcas} Encounters](talks/2023-04-20_rladies_orcas-web-scraping/). R-Ladies Seattle: R in the Outdoors Meetup. Seattle, WA. April 20, 2023.
...
-   Proficient in R, Microsoft Office, ArcGIS (Pro, Field Maps, Dashboards, and Experience).
-   Developing in Python, Arcade, SQL, WISKI.
